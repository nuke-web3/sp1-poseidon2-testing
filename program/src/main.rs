...
//     fields::bn256::{bytes_to_fp_elements_mont, fp_elements_to_bytes, FpBN256},
//     poseidon2::{poseidon2::Poseidon2, poseidon2_instance_bn256::POSEIDON2_BN256_PARAMS},
// };

pub fn main() {
    // // Load raw Montgomery-encoded field bytes
    ...
    // let result = poseidon.permutation(&field_inputs);

    // // Convert back to canonical form and write out
    // let output_bytes = fp_elements_to_bytes(&result);
